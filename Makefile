...
CORE_OBJS = ds4.o lgn.o lgn_model.o lgn_dflash.o ds4_ssd.o ds4_metal.o
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_gpu.h ds4_gpu_mgpu.h lgn.h lgn_model.h lgn_dflash.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c
...
ds4_test_hooks.o: ds4.c ds4.h ds4_ssd.h ds4_gpu.h lgn.h lgn_model.h lgn_dflash.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) -Wno-unused-function -DDS4_TEST_HOOKS -c -o $@ ds4.c

ds4_cpu_test_hooks.o: ds4.c ds4.h ds4_gpu.h ds4_gpu_mgpu.h lgn.h lgn_model.h lgn_dflash.h
...
ds4_streaming_test_hooks.o: ds4.c ds4.h ds4_gpu.h ds4_gpu_mgpu.h lgn.h lgn_model.h lgn_dflash.h
	$(CC) $(CFLAGS) -Wno-unused-function -DDS4_TEST_HOOKS -c -o $@ ds4.c

tests/test_ssd_streaming_hooks: tests/test_ssd_streaming_hooks.o ds4_streaming_test_hooks.o lgn.o lgn_model.o lgn_dflash.o ds4_help.o ds4_kvstore.o rax.o ds4_ssd.o ds4_metal_test_hooks.o | check-metal-sources
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)
