#!/usr/bin/env python3
"""Generate an SVG throughput graph from an lgn2-bench CSV file.
...
def main():
    parser = argparse.ArgumentParser(description="Plot lgn2-bench throughput CSV data as SVG.")
    parser.add_argument("csv", type=Path, help="input CSV produced by lgn2-bench")
