...
def main() -> int:
    ...
    ap.add_argument("--out", default="quality/data/laguna-openrouter-candidate")
    ap.add_argument("--prompts", default="quality/prompts.jsonl")
    ...
    ap.add_argument("--thinking", choices=("disabled", "enabled", "omit"), default="omit")
