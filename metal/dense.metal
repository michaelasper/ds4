...
// the weighted RMS-norm reduction tree with args.norm_threads virtual
...
kernel void kernel_mul_mv_f16_f32_rms_norm_4(
    ...
    // barrier, as in the weighted RMS-norm kernel.
...
// Paired F16 projections compute two same-shaped matvecs from the same
// activation. This keeps the exact dense F16 row-reduction shape for each
// matrix while sharing one dispatch and one activation stream.
template<short NR0, typename args_t>
